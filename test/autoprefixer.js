...
const prefixer = function(name) {
  if (name === 'grid') {
    ...
    return borderer;
  } else if ((name === 'vendor-hack') || (name === 'value-hack') || (name === 'mistakes')) {
    return cleaner;
  } else if (name === 'gradient') {
    return gradienter;
  } else if ((name === 'flexbox') || (name === 'flex-rewrite') || (name === 'double')) {
    return flexboxer;
...
describe('autoprefixer()', function() {
  ...
  return it('passes statistics to Browserslist', function() {
    const stats = {
      chrome: {
        10: 10,
        11: 40
...
describe('Autoprefixer', function() {
  ...
  it('prefixes transition', function() {
  ...
  it('works with broken transition', function() {
  ...
  it('should ignore spaces inside values', function() {
      const css = read('trim');
  ...
  it('removes unnecessary prefixes', () => (() => {
    const result = [];
    for (let type of Array.from(commons)) {
  ...
  it('parses difficult files', function() {
  ...
  it('uses browserslist config', function() {
  ...
  it('sets browserslist environment', function() {
    const path   = __dirname + '/cases/config/test.css';
    const input  = read('config/test');
  ...
  it('works without source in nodes', function() {
  ...
  it('takes values from other PostCSS plugins', function() {
  ...
  it('has option to disable @supports support', function() {
  ...
  it('has option to disable grid support', function() {
  ...
  it('has option to disable flexbox support', function() {
  ...
  it('has option to disable 2009 flexbox support', function() {
    const css      = 'a{flex:1}';
  ...
  return describe('hacks', function() {
    ...
    it('changes angle in gradient', function() {
    ...
    it('warns on old flexbox display', function() {
    ...
    it('warns on unsupported grid features', function() {
    ...
    it('does not warns on unsupported grid on disabled grid', function() {
      let result;
      const css    = read('nogrid');
      return result = postcss([prefixer('transition')]).process(css);
    });

    it('supports intrinsic sizing', function() {
    ...
    it('supports text-emphasis', function() {
    ...
    it('ignores values for CSS3PIE props', function() {
      const css = read('pie');
      return postcss([compiler]).process(css).css.should.eql(css);
    });

    return it('add prefix for backface-visibility for Safari 9', function() {
      const input = 'a{ ' +
