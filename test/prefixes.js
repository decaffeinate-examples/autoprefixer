...
describe('Prefixes', function() {
  ...
  describe('select()', () => it('selects necessary prefixes', () => fill.select(data.prefixes).should.eql({
    add: {
      a: ['-moz-'],
      b: ['-ms- new'],
      c: ['-ms-']
  ...
  describe('preprocess()', function() {
    ...
    it('preprocesses prefixes add data', () => fill.add.should.eql({
      'selectors': [cSel],
      'a': aProp,
      '*': {
        values: [bVal]
    ...
    return it('preprocesses prefixes remove data', () => JSON.stringify(fill.remove).should.eql(JSON.stringify({
  ...
  describe('.cleaner()', function() {
    ...
    return it('returns Prefixes with empty browsers', function() {
  ...
  describe('.unprefixed()', () => it('returns unprefixed version', () => empty.unprefixed('-moz-a').should.eql('a')));
  ...
  describe('values()', () => it('returns values for this and all properties', function() {
  ...
  return describe('group()', function() {
    ...
    describe('down()', function() {
      ...
      it('checks prefix group', function() {
      ...
      it('checks prefix groups', function() {
      ...
      return it('returns check decls inside group', function() {
