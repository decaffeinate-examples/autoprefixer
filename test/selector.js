...
describe('Selector', function() {
  ...
  describe('prefixed()', () => it('adds prefix after non-letters symbols', function() {
  ...
  describe('check()', () => it('shecks rule selectors', function() {
  ...
  describe('prefixeds()', () => it('returns all avaiable prefixed selectors', function() {
  ...
  describe('replace()', () => it('should add prefix to selectors', function() {
  ...
  return describe('old()', () => it('returns object to find old selector', function() {
