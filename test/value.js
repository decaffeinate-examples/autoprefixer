...
describe('Value', function() {
  ...
  describe('.save()', function() {
    ...
    it('clones declaration', function() {
    ...
    it('updates declaration with prefix', function() {
    ...
    it('ignores on another prefix property', function() {
    ...
    return it('ignores prefixes without changes', function() {
      const css   = parse('a { prop: v }');
      const width = css.first.first;
  ...
  describe('check()', () => it('checks value in string', function() {
  ...
  describe('old()', () => it('check prefixed value', function() {
    return this.calc.old('-ms-').should.eql(new OldValue('calc', '-ms-calc'));
  }));

  describe('replace()', () => it('adds prefix to value', function() {
